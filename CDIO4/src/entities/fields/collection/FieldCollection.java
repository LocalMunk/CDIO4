...
//	private desktop_fields.Field[] fields = new desktop_fields.Field[22];
	...
	public Field[] initialize()
	{
		...
		fields[17] = new ChanceField("Try your luck","Street", 18);
		fields[33] = new ChanceField("Try your luck", "is your luck shit?", 34);
		fields[36] = new ChanceField("Try your luck", "is your luck shit?", 37);
		...
		fields[10]	= new Territory ("Frederisksberg all�",	"Street", "Green",11,140 ,10);
		fields[12]	= new Territory ("B�lwsvej",			"Street", "Green",13,140 ,10);
		fields[13] 	= new Territory ("Gammelkonge vej", 	"Street", "Green",14,60 ,10);
		fields[15] 	= new Territory ("Bernsstoffvej",		"Street", "Grey",16,180 ,10);
		fields[21] 	= new Territory ("Hellerupvej",			"Street", "Grey",22,180 ,10);
		fields[19] 	= new Territory ("Strandvejen",			"Street", "Grey",20,180 ,10);
		fields[22] 	= new Territory ("Trianglen",			"Street", "Red",23,220 ,10);
		fields[23] 	= new Territory("�sterbrogade", 		"Street", "Red", 24, 220, 10);
		fields[24] 	= new Territory("Gr�nningen", 			"Street", "Red", 25, 240, 10);
		fields[26] 	= new Territory("Bredgade", 			"Street", "White", 27, 260,10);
		fields[27] 	= new Territory("Kgs. Nytorv", 			"Street", "White", 28, 260, 10);
		fields[29] 	= new Territory("�stergade", 			"Street", "White", 30, 280,10);
		fields[31] 	= new Territory("Amagertorv", 			"Street", "Yellow", 32, 300, 10);
		fields[32] 	= new Territory("Vimmelskaftet", 		"Street", "Yellow", 33, 300, 10);
		fields[35] 	= new Territory("Nygade",				"Street", "Yellow", 36, 320,10);
		fields[39] 	= new Territory("Frederiksberggade", 	"Street", "Purple", 40, 350, 10);
		fields[38] 	= new Territory("R�dhuspladsen", 		"Street", "Purple", 39, 400, 10);
		
		//Tax
		fields[4] = new Tax("Pay Tax","You need to pay taxes",5,200,10);
		fields[37] = new Tax("Skat", "Pay your damned taxes", 38, 200, 10);
		
		//Fleet
		fields[5] = new Fleet ("�resundsredderiet","Fleet",6,200, fleetRent);
		fields[14] = new Fleet("DFDS","Fleet",15,200 , fleetRent);
		fields[25] = new Fleet("�.S. redderiet", "Fleet", 26, 200, fleetRent);
		fields[34] = new Fleet("Bornholm", "Fleet", 35, 200, fleetRent);
		
		//Jail
		fields[11] = new Jail ("Jail","Your jailed bitch",12);
		fields[30] = new GoToJail("Go to jail", "go to jail", 31);
		
		//Brewery
		fields[16] = new Brewery ("Tuborg","Brewery",17, 150, 10, diceone);
		fields[28] = new Brewery("Carlsberg", "Brewery", 29, 150, 100, diceone);
		
		//Parking
		fields[20] = new FreeParking ("Helle","Park free here",21);

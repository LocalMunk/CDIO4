...
//	private desktop_fields.Field[] fields = new desktop_fields.Field[22];
	...
	public Field[] initialize()
	{
		...
		//Territory
		fields[1] 	= new Territory("R�dovrevej",			"Street", "Blue",1,1200, new int[] {50,250,750,2250,4000,6000} );
		...
		fields[9] 	= new Territory ("Alle gad�",			"Street", "Salmon",9,2400 ,new int[]{150,800,2000,6000,9000,12000});
		fields[10]	= new Territory ("Frederisksberg all�",	"Street", "Green",10,2800 ,new int[]{200,1000,3000,9000,12500,15000});
		fields[12]	= new Territory ("B�lwsvej",			"Street", "Green",12,2800 ,new int[]{200,1000,3000,9000,12500,15000});
		fields[13] 	= new Territory ("Gammelkonge vej", 	"Street", "Green",13,3200 ,new int[]{250,1250,3750,1000,14000,18000});
		fields[15] 	= new Territory ("Bernsstoffvej",		"Street", "Grey",15,3600 ,new int[]{300,1400,4000,11000,15000,19000});
		fields[21] 	= new Territory ("Hellerupvej",			"Street", "Grey",21,3600 ,new int[]{300,1400,4000,11000,15000,1900});
		fields[19] 	= new Territory ("Strandvejen",			"Street", "Grey",19,4000 ,new int[]{350,600,4400,12000,16000,19000});
		fields[22] 	= new Territory ("Trianglen",			"Street", "Red",22,4400 ,new int[]{300,1800,5000,14000,17500,21000});
		fields[23] 	= new Territory("�sterbrogade", 		"Street", "Red", 23, 4400, new int[]{350,1800,5000,14000,17500,21000});
		fields[24] 	= new Territory("Gr�nningen", 			"Street", "Red", 24, 4800, new int[]{300,1800,5000,14000,17500,21000});
		...
		fields[29] 	= new Territory("�stergade", 			"Street", "White", 29, 5600,new int[]{500,2400,7200,17000,20500,24000});
		...
		fields[38] 	= new Territory("R�dhuspladsen", 		"Street", "Purple", 38, 8000,new int[]{1000,4000,12000,28000,34000,40000});
		...
		//Fleet
		fields[5] = new Fleet ("�resundsredderiet","Fleet",5,4000, fleetRent);
		fields[14] = new Fleet("DFDS","Fleet",14,4000 , fleetRent);
		fields[25] = new Fleet("�.S. redderiet", "Fleet", 25, 4000, fleetRent);
